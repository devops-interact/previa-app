        ...
        <AuthGuard>
            <div className="flex h-screen bg-previa-background overflow-hidden">
                ...
                <main className="flex-1 flex flex-col overflow-hidden min-w-0">
                    ...
                    <header className="bg-previa-surface border-b border-previa-border px-4 py-3 sm:px-6 flex-shrink-0">
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            <div className="flex items-center gap-3 min-w-0">
                                <Building2 className="w-5 h-5 text-previa-accent flex-shrink-0" />
                                <div className="min-w-0">
                                    <h1 className="text-sm sm:text-base font-semibold text-previa-ink truncate">
                            ...
                            <div className="flex items-center gap-2 flex-shrink-0">
                                <button
                                    ...
                                    className="flex items-center justify-center gap-1.5 px-3 py-2 sm:py-1.5 bg-previa-accent text-white text-xs rounded-lg hover:bg-previa-accent/90 transition-colors font-semibold"
                                >
                    ...
                    {/* Toolbar — responsive padding and wrap */}
                    <div className="bg-previa-surface border-b border-previa-border px-4 py-2 sm:px-6 flex-shrink-0">
                    ...
                    <div className="flex-1 overflow-auto px-3 py-3 sm:px-4 sm:py-4 lg:px-5 lg:py-5">
                        {loading ? (
