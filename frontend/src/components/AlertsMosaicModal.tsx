            ...
            <div className="flex items-center gap-4 px-6 h-14 border-b border-previa-border bg-previa-surface flex-shrink-0">
                ...
                <div className="ml-auto flex items-center gap-2">
                    ...
                    >
                        ...
                        <span>Filtros</span>
                        {activeFilterCount > 0 && (
                            <span className="w-4 h-4 rounded-full border border-previa-accent/60 bg-previa-surface text-previa-ink text-[10px] flex items-center justify-center font-bold">
                                {activeFilterCount}
                            </span>
                        )}
                    </button>
